...
## Installation:
 ...
 ## One Click : [Install](https://github.com/alphaxleonidas/IGN-Metadata-Injector/raw/refs/heads/main/userscript/ign-metadata-injector.user.js)
...
- Now the extension will be installed and a new Chromium window will appear. This is where we can follow steps from [#Chrome/Chromium](https://github.com/alphaxleonidas/IGN-Metadata-Injector/new/main?filename=README.md#chromechromium)
